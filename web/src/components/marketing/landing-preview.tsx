  ...
  return (
    <div className="overflow-hidden rounded-2xl border border-zinc-200/90 bg-zinc-950 text-zinc-100 shadow-2xl shadow-zinc-900/40 ring-1 ring-white/10">
      <div className="flex items-center gap-2 border-b border-zinc-800 px-4 py-3">
        ...
        <span className="text-xs font-medium text-zinc-400">Admin · EthioLocal</span>
      ...
      <div className="grid gap-3 p-4 md:grid-cols-[1fr_1.2fr]">
        <div className="space-y-3">
          <div className="rounded-xl border border-zinc-800 bg-zinc-900/80 p-3">
            <p className="text-[10px] font-medium uppercase tracking-wide text-zinc-500">Revenue</p>
            <p className="mt-1 text-xl font-semibold text-white">ETB 128,400</p>
            <p className="text-[10px] text-emerald-400">+12% vs last week</p>
          </div>
      ...
      <div className="overflow-hidden rounded-[2rem] border-4 border-zinc-800 bg-zinc-900 p-2 shadow-2xl shadow-zinc-900/50 ring-1 ring-zinc-700">
        <div className="overflow-hidden rounded-[1.35rem] bg-white">
          <div className="bg-gradient-to-r from-violet-600 to-indigo-600 px-4 py-6 text-white">
            <p className="text-xs font-medium opacity-90">Good morning</p>
            <p className="text-lg font-semibold">Nearby deals</p>
          </div>
          <div className="space-y-3 p-3">
            {[1, 2, 3].map((i) => (
              <div key={i} className="flex gap-3 rounded-xl border border-zinc-100 bg-zinc-50/80 p-2">
                <div className="size-14 shrink-0 rounded-lg bg-gradient-to-br from-violet-200 to-indigo-100" />
                <div className="flex flex-1 flex-col justify-center gap-1.5">
                  <div className="h-2 w-3/4 rounded-full bg-zinc-200" />
                  <div className="h-2 w-1/2 rounded-full bg-zinc-100" />
                  <p className="text-xs font-semibold text-violet-600">Compare 3 sellers</p>
                </div>
              </div>
            ))}
          </div>
          <div className="mx-3 mb-3 flex justify-around rounded-2xl border border-zinc-100 bg-zinc-50 py-2 text-zinc-400">
            <span className="text-[10px]">Home</span>
            <span className="text-[10px] font-medium text-violet-600">Explore</span>
    ...
    <section id="preview" className="scroll-mt-24 py-20 md:py-28">
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          >
            Web command center, mobile momentum
          </motion.h2>
          <motion.p variants={fadeItem} className="mt-4 text-pretty text-lg text-zinc-600">
            Operators see the full picture on the dashboard; buyers stay in flow with the Flutter app experience.
          </motion.p>
        </motion.div>
        ...
        <div className="mt-16 grid items-center gap-12 lg:grid-cols-[1.15fr_0.85fr] lg:gap-16">
          <motion.div
            ...
            className="relative"
          >
            <div className="absolute -inset-4 rounded-3xl bg-gradient-to-br from-violet-500/15 via-transparent to-indigo-500/10 blur-2xl" aria-hidden />
