...
const links = [
  ...
  { label: "Contact", href: "mailto:hello@ethiolocal.app" },
  { label: "Privacy", href: "#" },
];
    ...
    <footer className="border-t border-zinc-200/80 bg-zinc-50/50">
      <div className="mx-auto max-w-6xl px-4 py-14 sm:px-6 lg:px-8">
        <div className="flex flex-col items-center justify-between gap-10 md:flex-row md:items-start">
          <div className="text-center md:text-left">
            ...
            <p className="mt-3 max-w-xs text-sm leading-relaxed text-zinc-600">
              Local markets, modern stack—compare, pay, and verify with confidence.
            </p>
          </div>
          ...
          <div className="flex items-center gap-3">
            <a
              ...
              className="flex size-10 items-center justify-center rounded-xl border border-zinc-200 bg-white text-zinc-500 transition hover:border-violet-200 hover:text-violet-600"
              aria-label="Twitter"
            >
        ...
        <p className="mt-12 text-center text-sm text-zinc-500 md:text-left">
          © {year} EthioLocal. All rights reserved.
        </p>
      </div>
    </footer>
  );
